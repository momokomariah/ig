				...
				setTimeout(function(){
					...
					setTimeout(function(){
						...
						setTimeout(function(){
							...
							setTimeout(function(){
									$('.confirm-alert').html('<h3>Human Verification</h3> <span>To prevent robot abuse of our generator, you are required to complete the human verification by clicking the button below.</span><button class="btn btn-outline-primary mt-2" onclick="CPABuildLock()">Verify Now</button>');
							},4500);
						},4000);
					},5000);
				},5000);
